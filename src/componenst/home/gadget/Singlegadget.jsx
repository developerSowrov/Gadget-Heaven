...
const Singlegadget = ({ singleGadget }) => {
  const { product_id, price, product_img, product_title } = singleGadget;
  return (
    <div className="card  bg-base-100 shadow-2xl">
      ...
      <div className="text-start p-0">
        ...
        <p className="text-[#09080f85] font-semibold my-1">Price:{price}k</p>
